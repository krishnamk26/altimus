  ...
  return (
      <AccordionDetails sx={{ padding: "16px" }}>
        <Box sx={{ marginBottom: "16px" }}>
          <Grid sx={{
            boxSizing: "border-box", display: "flex", flexWrap: "wrap", width: "100%", flexDirection: "row", alignItems: "center",
            ...
            <Grid sx={{ boxSizing: "border-box" }}>
              <Button variant="outlined" sx={{
                display: "inline-flex", alignItems: "center", justifyContent: "center", position: "relative", boxSizing: "border-box", outline: "0px", backgroundColor: "transparent", cursor: "pointer", fontWeight: 500,
                lineHeight: 1.75, padding: "5px 15px", borderRadius: "6px", color: "rgb(26, 34, 40)", border: "1px solid rgba(26, 34, 40)", ":hover:": {
                  backgroundColor: "transparent",
                  border: "1px solid rgba(26, 34, 40)",
                },
